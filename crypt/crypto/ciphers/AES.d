...
module ocean.crypt.crypto.ciphers.AES;
    ...
    private void encryptBlock()
    {
        ...
        while (--r >= 0)
        {
            t0 = w[i++] ^ TE0[s0 >> 24] ^
                          ...
                          TE3[cast(ubyte) s3];
            t1 = w[i++] ^ TE0[s1 >> 24] ^
                          TE1[cast(ubyte)(s2 >> 16)] ^
                          TE2[cast(ubyte)(s3 >> 8)]  ^ 
                          TE3[cast(ubyte) s0];
            t2 = w[i++] ^ TE0[s2 >> 24] ^
                          TE1[cast(ubyte)(s3 >> 16)] ^
                          TE2[cast(ubyte)(s0 >> 8)] ^
                          TE3[cast(ubyte) s1];
            t3 = w[i++] ^ TE0[s3 >> 24] ^
                          TE1[cast(ubyte)(s0 >> 16)] ^
                          TE2[cast(ubyte)(s1 >> 8)] ^
                          TE3[cast(ubyte) s2];
            ...
            s0 = w[i++] ^ TE0[t0 >> 24] ^
                          TE1[cast(ubyte)(t1 >> 16)] ^
                          TE2[cast(ubyte)(t2 >> 8)] ^
                          TE3[cast(ubyte) t3];
            s1 = w[i++] ^ TE0[t1 >> 24] ^
                          TE1[cast(ubyte)(t2 >> 16)] ^
                          TE2[cast(ubyte)(t3 >> 8)] ^
                          TE3[cast(ubyte) t0];
            s2 = w[i++] ^ TE0[t2 >> 24] ^
                          TE1[cast(ubyte)(t3 >> 16)] ^
                          TE2[cast(ubyte)(t0 >> 8)] ^
                          TE3[cast(ubyte) t1];
            s3 = w[i++] ^ TE0[t3 >> 24] ^
                          TE1[cast(ubyte)(t0 >> 16)] ^
                          TE2[cast(ubyte)(t1 >> 8)] ^
                          TE3[cast(ubyte) t2];
        }
        ...
        // Final round
        s0 = w[i++] ^ (S[t0 >> 24] << 24) ^
                      (S[cast(ubyte)(t1 >> 16)] << 16) ^
                      (S[cast(ubyte)(t2 >> 8)] << 8) ^
                       S[cast(ubyte) t3];
        s1 = w[i++] ^ (S[t1 >> 24] << 24) ^
                      (S[cast(ubyte)(t2 >> 16)] << 16) ^
                      (S[cast(ubyte)(t3 >> 8)] << 8) ^
                       S[cast(ubyte) t0];
        s2 = w[i++] ^ (S[t2 >> 24] << 24) ^
                      (S[cast(ubyte)(t3 >> 16)] << 16) ^
                      (S[cast(ubyte)(t0 >> 8)] << 8) ^
                       S[cast(ubyte) t1];
        s3 = w[  i] ^ (S[t3 >> 24] << 24) ^
                      (S[cast(ubyte)(t0 >> 16)] << 16) ^
                      (S[cast(ubyte)(t1 >> 8)] << 8) ^
                       S[cast(ubyte) t2];
    }
    ...
    private void decryptBlock()
    {
        ...
        while (--r >= 0)
        {
            t0 = w[i++] ^ TD0[s0 >> 24] ^
                          ...
                          TD3[cast(ubyte) s1];
            t1 = w[i++] ^ TD0[s1 >> 24] ^
                          TD1[cast(ubyte)(s0 >> 16)] ^
                          TD2[cast(ubyte)(s3 >> 8)]  ^ 
                          TD3[cast(ubyte) s2];
            t2 = w[i++] ^ TD0[s2 >> 24] ^
                          TD1[cast(ubyte)(s1 >> 16)] ^
                          TD2[cast(ubyte)(s0 >> 8)] ^
                          TD3[cast(ubyte) s3];
            t3 = w[i++] ^ TD0[s3 >> 24] ^
                          TD1[cast(ubyte)(s2 >> 16)] ^
                          TD2[cast(ubyte)(s1 >> 8)] ^
                          TD3[cast(ubyte) s0];
            ...
            s0 = w[i++] ^ TD0[t0 >> 24] ^
                          TD1[cast(ubyte)(t3 >> 16)] ^
                          TD2[cast(ubyte)(t2 >> 8)] ^
                          TD3[cast(ubyte) t1];
            s1 = w[i++] ^ TD0[t1 >> 24] ^
                          TD1[cast(ubyte)(t0 >> 16)] ^
                          TD2[cast(ubyte)(t3 >> 8)] ^
                          TD3[cast(ubyte) t2];
            s2 = w[i++] ^ TD0[t2 >> 24] ^
                          TD1[cast(ubyte)(t1 >> 16)] ^
                          TD2[cast(ubyte)(t0 >> 8)] ^
                          TD3[cast(ubyte) t3];
            s3 = w[i++] ^ TD0[t3 >> 24] ^
                          TD1[cast(ubyte)(t2 >> 16)] ^
                          TD2[cast(ubyte)(t1 >> 8)] ^
                          TD3[cast(ubyte) t0];
        }
        
        s0 = w[i++] ^ (RS[t0 >> 24] << 24) ^
                      (RS[cast(ubyte)(t3 >> 16)] << 16) ^
                      (RS[cast(ubyte)(t2 >> 8)] << 8) ^
                       RS[cast(ubyte) t1];
        s1 = w[i++] ^ (RS[t1 >> 24] << 24) ^
                      (RS[cast(ubyte)(t0 >> 16)] << 16) ^
                      (RS[cast(ubyte)(t3 >> 8)] << 8) ^
                       RS[cast(ubyte) t2];
        s2 = w[i++] ^ (RS[t2 >> 24] << 24) ^
                      (RS[cast(ubyte)(t1 >> 16)] << 16) ^
                      (RS[cast(ubyte)(t0 >> 8)] << 8) ^
                       RS[cast(ubyte) t3];
        s3 = w[  i] ^ (RS[t3 >> 24] << 24) ^
                      (RS[cast(ubyte)(t2 >> 16)] << 16) ^
                      (RS[cast(ubyte)(t1 >> 8)] << 8) ^
                       RS[cast(ubyte) t0];
    }
