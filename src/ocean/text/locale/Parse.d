...
package Time parseTimeExact(char[] s, cstring format, DateTimeFormat dtf) {
  DateTimeParseResult result;
...
package bool tryParseTimeExact(char[] s, cstring format, DateTimeFormat dtf, out Time result) {
  result = Time.min;
  DateTimeParseResult resultRecord;
...
private bool tryParseExactMultiple(char[] s, istring[] formats, DateTimeFormat dtf, ref DateTimeParseResult result) {
...
private bool tryParseExact(char[] s, cstring pattern, DateTimeFormat dtf, ref DateTimeParseResult result) {
  ...
  bool doParse() {
    ...
    bool parseOne(char[] s, ref int pos, cstring value) {
    ...
    int parseMultiple(char[] s, ref int pos, istring[] values ...) {
      int result = -1;
      size_t max;
    ...
    istring stringOf(char c, int count = 1) {
