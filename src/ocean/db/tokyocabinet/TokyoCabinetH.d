...
class TokyoCabinetH : ITokyoCabinet!(TCHDB, tchdbforeach)
{
    ...
    ***************************************************************************/
    ...
    public this ( )
    {
        debug Stderr.formatln(typeof (this).stringof ~ " created");
    ...
    private ~this ( )
    {
        if (!this.deleted)
        {
            ...
            debug
            {
                Stderr.formatln(typeof (this).stringof ~ " deleted");
            }
        }
    ...
    {
        debug Stderr.formatln(typeof (this).stringof ~ " opened {}", dbfile);
        this.db_name = dbfile;
    ...
    ***************************************************************************/
    ...
    public void close ()
    {
        scope ( failure )
        {
            debug Stderr.formatln(typeof (this).stringof ~ " error closing {}", this.db_name);
        }
        scope ( success )
        {
            debug Stderr.formatln(typeof (this).stringof ~ " closed {}", this.db_name);
        }
