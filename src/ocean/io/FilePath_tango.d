...
unittest
{
    ...
    assert (fp.pop == r"/home/foo/bar/john");
    assert (fp.pop == r"/home/foo/bar");
    assert (fp.pop == r"/home/foo");
    assert (fp.pop == r"/home");
    assert (fp.pop == r"/");
    assert (fp.pop == r"");

    // special case for popping empty names
    fp.set (r"/home/foo/bar/john/");
    assert (fp.parent == r"/home/foo/bar");
    ...
    assert (fp == r"/home/foo/bar/john/");
    assert (fp.path == r"/home/foo/bar/john/");
    assert (fp.file == "");
    assert (fp.suffix == "");
    assert (fp.root == "");
    assert (fp.ext == "");
    ...
    assert (fp == r"/home/foo/bar");
    assert (fp.path == r"/home/foo/");
    ...
    assert (fp == r"/home/foo");
    assert (fp.path == r"/home/");
    ...
    assert (fp.suffix == r".bar");
    assert (fp == r"/a/b/c/d/e/f/g/foo.bar");
    assert (fp.name == "foo");
