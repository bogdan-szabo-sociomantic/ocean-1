...
class ChaCha : Salsa20
{
    ...
    protected override void keySetup()
    {
        uint offset;
        ubyte[] constants;
    ...
    protected override void ivSetup()
    {
        state[12] = state[13] = 0;
    ...
    protected override void salsa20WordToByte(uint[] input, ref ubyte[] output)
    {
        uint[] x = new uint[16];
        x[] = input;
