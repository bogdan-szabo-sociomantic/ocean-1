...
public:
    ...
    static BigInt opCall(T : cstring)(T z) {
        cstring s = z;
        BigInt r;
        bool neg = false;
        if (s[0] == '-') {
    ...
    static BigInt opCall(T : long)(T x) {
        BigInt r;
    ...
    ptrdiff_t uintLength() { return data.uintLength(); }
    ...
    ptrdiff_t ulongLength() { return data.ulongLength(); }
