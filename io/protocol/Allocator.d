...
module ocean.io.protocol.Allocator;
...
+/        
        ...
        ***********************************************************************/
        ...
        final void[] allocate (Protocol.Reader reader, uint bytes, Protocol.Type type)
        {
...
class HeapSlice : Allocator
{
        ...
        ***********************************************************************/
        ...
        this (Protocol protocol, uint width=4096, bool autoreset=false)
        {
                protocol_ = protocol;
...
+/        
        ...
        ***********************************************************************/
        ...
        final void[] allocate (Protocol.Reader reader, uint bytes, Protocol.Type type)
        {
                return protocol_.bin.slice (bytes, true);
        }
}
