...
abstract class IChainSelectProtocol : IAdvancedSelectClient
{
    ...
    public enum ChainFinishedStatus
    {
        Unregister = 0,
        Select = 1, 
        Continue = 2 
    ...
    public alias ChainFinishedStatus delegate ( ) FinishChainDg;
    ...
    protected AppendBuffer!(ubyte) data;
    ...
    private   EpollSelectDispatcher dispatcher_;
    ...
    private   AppendBuffer!(IOHandler) io_handlers;
    ...
    private   FinishChainDg finish_chain = null;
...
//        this.data.length = 0;
        this.data = new AppendBuffer!(ubyte)(buffer_size);
        this.io_handlers = new AppendBuffer!(IOHandler);
    ...
    /**************************************************************************
        ...
        Params:
            ...
            finish_chain = Session Finalizer, pass null to provide no Finalizer
    ...
    public typeof (this) setIOHandlers ( IOHandler[] io_handlers, FinishChainDg finish_chain = null )
    {
        this.io_handlers[] = io_handlers;

        this.handler_index = 0;

        this.finish_chain = finish_chain;
    ...
    public typeof (this) setIOHandlers ( IOHandler io_handler, FinishChainDg finish_chain = null )
    {
        return this.setIOHandlers(toArray(io_handler), finish_chain);
    }
    ...
    public typeof(this) register ( )
    {
        ...
        this.dispatcher_.register(this);
    ...
    public typeof(this) unregister ( )
    {
        ...
        this.dispatcher_.unregister(this);
    ...
    public typeof(this) safeUnregister ( )
    {
        ...
        this.dispatcher_.safeUnregister(this);
    ...
    protected bool invokeHandlers ( )
    {
        ...
        {
            super.error(cast(Exception)e, Event.None); // notifies error reporter

            more = false;

            this.io_handlers.clear();
        }
    ...
    **************************************************************************/
    ...
    /**************************************************************************
        ...
        Returns:
            the epoll select dispatcher

     **************************************************************************/

    public EpollSelectDispatcher dispatcher ( )
    {
    ...
    body
    {
        ...
        bool more = this.io_handlers[this.handler_index](this.data[this.pos .. this.data.length], c);
    ...
    /**************************************************************************
        ...
        Returns:
            Passes through the return value of the FinishChainDg.
    
     **************************************************************************/

    private ChainFinishedStatus finishChain ( )
    {
        bool have_finish_chain_dg = !!this.finish_chain;

        this.handler_index      = 0;

        this.io_handlers.clear();

        super.unregisterTimeout();

        return have_finish_chain_dg? this.finish_chain() : ChainFinishedStatus.Unregister;
    }
