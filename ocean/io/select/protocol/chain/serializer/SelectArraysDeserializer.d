/*******************************************************************************
    ...
    ---
        ...
        import ocean.io.select.protocol.chain.serializer.SelectArraysDeserializer;
...
module ocean.io.select.protocol.chain.serializer.SelectArraysDeserializer;
...
private import ocean.io.select.protocol.chain.serializer.SelectDeserializer;
        ...
        do
        {
            with ( State ) switch ( this.state )
            {
                ...
                case GetFirstArray:
                    ...
                    if ( this.lzo.isStartChunk(cast(char[])this.array) )
                    {
