/*******************************************************************************
    ...
    ---
        ...
        import ocean.io.select.protocol.chain.serializer.SelectArraysSerializer;
...
module ocean.io.select.protocol.chain.serializer.SelectArraysSerializer;
...
private import ocean.io.select.protocol.chain.serializer.model.ISelectArraysTransmitter;

private import ocean.io.select.protocol.chain.serializer.SelectSerializer;
    ...
    ***************************************************************************/
    ...
    private class CompressingArraySerializer : ArraySerializer
    {
        ...
        ***********************************************************************/
        ...
        {
            auto result = cast(void[])this.outer.lzo.compress(cast(char[])data);
