...
/* This is the version number of the libcurl package from which this header
   file origins: */
//C     #define LIBCURL_VERSION "7.15.4"

/* The numeric version number is also available "in parts" by using these
   defines: */
//C     #define LIBCURL_VERSION_MAJOR 7
//C     #define LIBCURL_VERSION_MINOR 15
const LIBCURL_VERSION_MAJOR = 7;
//C     #define LIBCURL_VERSION_PATCH 4
const LIBCURL_VERSION_MINOR = 15;
...
*/
//C     #define LIBCURL_VERSION_NUM 0x070f04

const LIBCURL_VERSION_NUM = 0x070f04;
 ...
 * platforms.
 */
//C     #if defined(__STDC__) || defined(_MSC_VER) || defined(__cplusplus) ||   defined(__HP_aCC) || defined(__BORLANDC__) || defined(__LCC__) ||   defined(__POCC__) || defined(__SALFORDC__)
...
//C       CINIT(TCP_NODELAY, LONG, 121),
  ...
  /* When doing 3rd party transfer, set the source user and password with
     this */
//C       CINIT(SOURCE_USERPWD, OBJECTPOINT, 123),
...
//C       CINIT(SOURCE_PREQUOTE, OBJECTPOINT, 127),

  /* When doing 3rd party transfer, set the source post-quote linked list
     of commands with this */
//C       CINIT(SOURCE_POSTQUOTE, OBJECTPOINT, 128),
...
//C       CINIT(SOURCE_URL, OBJECTPOINT, 132),

  /* When doing 3rd party transfer, set the source quote linked list of
     commands with this */
//C       CINIT(SOURCE_QUOTE, OBJECTPOINT, 133),
...
/* define this to test if your app builds with all
                          the obsolete stuff removed! */
//C     #define CURLOPT_HTTPREQUEST    -1
//C     #define CURLOPT_FTPASCII       CURLOPT_TRANSFERTEXT
const CURLOPT_HTTPREQUEST = -1;
//C     #define CURLOPT_MUTE           -2
alias CURLOPT_TRANSFERTEXT CURLOPT_FTPASCII;
//C     #define CURLOPT_PASSWDFUNCTION -3
const CURLOPT_MUTE = -2;
//C     #define CURLOPT_PASSWDDATA     -4
const CURLOPT_PASSWDFUNCTION = -3;
//C     #define CURLOPT_CLOSEFUNCTION  -5
const CURLOPT_PASSWDDATA = -4;

const CURLOPT_CLOSEFUNCTION = -5;
//C     #define CURLOPT_SOURCE_HOST    -6
//C     #define CURLOPT_SOURCE_PATH    -7
const CURLOPT_SOURCE_HOST = -6;
//C     #define CURLOPT_SOURCE_PORT    -8
const CURLOPT_SOURCE_PATH = -7;
//C     #define CURLOPT_PASV_HOST      -9
const CURLOPT_SOURCE_PORT = -8;

const CURLOPT_PASV_HOST = -9;
//C     #else
...
alias _N22 curl_version_info_data;
...
//C     #if defined(WIN32) && !defined(_WIN32_WCE) && !defined(__GNUC__) ||   defined(__MINGW32__)
...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   ...
   require it! */
//C     #if defined(_AIX) || defined(NETWARE) || defined(__NetBSD__)
...
//C     typedef enum {
//C       CURLM_CALL_MULTI_PERFORM = -1, /* please call curl_multi_perform() soon */
//C       CURLM_OK,
...
//C                                         void *userp);    /* "private" pointer */
alias int  function(CURL *easy, curl_socket_t s, int what, void *userp)curl_socket_callback;

//C     CURLMcode curl_multi_socket(CURLM *multi_handle, curl_socket_t s);
CURLMcode  curl_multi_socket(CURLM *multi_handle, curl_socket_t s);

//C     CURLMcode curl_multi_socket_all(CURLM *multi_handle);
 ...
 */
//C     CURLMcode curl_multi_timeout(CURLM *multi_handle, long *milliseconds);
 ...
 * Returns: CURLM error code.
 */
//C     CURLMcode curl_multi_setopt(CURLM *multi_handle,
