module ocean.net.client.curl.c.multi;
...
enum CURLMoption {
    ...
    SOCKETFUNCTION = CURLOPTTYPE_FUNCTIONPOINT + 1,

    /* This is the argument passed to the socket callback */
    SOCKETDATA = CURLOPTTYPE_OBJECTPOINT + 2,

      /* set to 1 to enable pipelining for this multi handle */
    PIPELINING = CURLOPTTYPE_LONG + 3,

     /* This is the timer callback function pointer */
    TIMERFUNCTION = CURLOPTTYPE_FUNCTIONPOINT + 4,

    /* This is the argument passed to the timer callback */
    TIMERDATA = CURLOPTTYPE_OBJECTPOINT + 5,

    /* maximum number of entries in the connection cache */
    MAXCONNECTS = CURLOPTTYPE_LONG + 6,
